...
import onight.act.ordbgens.act.entity.TActLogsHisExample.Criterion;
import onight.act.ordbgens.act.entity.TActLogsHisExample;

public class TActLogsHisSqlProvider {
     ...
     */
    public String countByExample(TActLogsHisExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("T_ACT_LOGS_HIS");
     ...
     * @mbggenerated Tue Jan 12 21:56:03 CST 2016
     */
    public String deleteByExample(TActLogsHisExample example) {
        BEGIN();
        DELETE_FROM("T_ACT_LOGS_HIS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Tue Jan 12 21:56:03 CST 2016
     */
    public String insertSelective(TActLogsHis record) {
        BEGIN();
        INSERT_INTO("T_ACT_LOGS_HIS");
     ...
     * @mbggenerated Tue Jan 12 21:56:03 CST 2016
     */
    public String selectByExample(TActLogsHisExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TActLogsHis record = (TActLogsHis) parameter.get("record");
        TActLogsHisExample example = (TActLogsHisExample) parameter.get("example");
     ...
     * @mbggenerated Tue Jan 12 21:56:03 CST 2016
     */
    public String updateByPrimaryKeySelective(TActLogsHis record) {
        BEGIN();
        UPDATE("T_ACT_LOGS_HIS");
     ...
     * @mbggenerated Tue Jan 12 21:56:03 CST 2016
     */
    protected void applyWhere(TActLogsHisExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
